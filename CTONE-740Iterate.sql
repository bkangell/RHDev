-- CTONE-740: script to update UseGroupNo to No in ProcedureCodeRate FOR 2000 AmeriHealth
-- TEST --sp_MSForEachDB 'USE ? IF ''?'' LIKE ''ASP_MMHLA_QA''
-- EXECUTE FOR sp_MSForEachDB 'USE ? IF ''?'' LIKE ''ASP_LA_MASTER''
